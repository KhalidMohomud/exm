             ...
             if(status){
                ...
                response.forEach( itm => {
                    ...
                    for(let i in itm){
                        ...
                        tr += `<td ><a class="view_cl" view_id=${itm['student_id']}><span class="material-symbols-outlined" style ="color:#fff;background-color:black;font-size: xx-large;  font-weight: bold; border-radius: 5px;">visibility
                        </span></a>
