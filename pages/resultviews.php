...
<head>
  ...
  <link rel="stylesheet" href="../style/resultviews.css">
...
?>
  ...
  <main>
    ...
    <div class="container-resultviews">
       
  
         
        <!-- <button class="Addbtn-resultviews" id="openModalBtn"><span class="material-symbols-outlined">
            add
            </span></button> -->
           
            <h2 id="facte_h2"> resultviews</h2>
            <form id="repotbtn" >
         <div class="sections">

           <!-- <label for="class">class</label> -->
           <input type="number" placeholder="Enter student_id" name = "_student_id" id="_student_id">
        
           <select id="_semester_id" name="_semester_id" >
...
if (mysqli_num_rows($sql) > 0) {
 ...
 ?> 
        ...
        <button type="submit" id="repotbtn">
        search</button>
        </form>
        </div> 
...
<!-- <button class="Expectbtn" id="export_statement"><span class="material-symbols-outlined">
    ...
    <!-- <div class="modal-resultviews" id="modal-resultviews">
           ...
           <h3 id="selectedClassName"></h3>
           <h3 id="selectedmester"></h3>
                <h2>resultviewse Froms</h2>

               
                <form  id="form_resultviews" >
...
<script type="text/javascript" src="../node_modules/resultviews.js" defer></script>
</html>
