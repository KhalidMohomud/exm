...
?>
  ...
  <main>
    ...
    <div class="container-users">
        ...
        <button class="Addbtn-users" id="openModalBtn"><span class="material-symbols-outlined">
            add
            </span></button>
        ...
        <div class="modal-user" id="modal-user">
                ...
                <h2>User Froms</h2>
                <form id="Users_from">
                    <input type="hidden" name="id" idid>
                    ...
                    <div class="button-group">
                        <button type="button"  id="closebtn" name="closebtn" >close</button>
...
<script type="text/javascript" src="../node_modules/users.js" defer></script>
</html>
