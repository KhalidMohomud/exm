...
?>
  ...
  <main>
    ...
    <div class="container-results">
        ...
        <!-- <button class="Addbtn-result" id="openModalBtn"><span class="material-symbols-outlined">
            add
            </span></button> -->
           
            <h2 id="facte_h2">Registration result</h2>
...
#$sql = mysqli_query($conn, "SELECT * FROM semester");
  ...
  #  while ($row = mysqli_fetch_assoc($sql)) {
        #echo "<option value='{$row['semester']}'>{$row['semester_name']} </option>";
...
<script type="text/javascript" src="../node_modules/result.js" defer></script>
</html>
